...
const form = () => {
  ...
  >
    {(formik) => (
      ...
      <Form>
        <h1 className="text-3xl font-bold">Hey, developers 👋</h1>
    <p className="mt-3 text-neutral-700">We'll send a OTP code to your email for a password - free log in</p>
    <div className="mt-5 space-y-5"><div className="space-y-2">
    <Controls
              control="input"
              type="email"
              label="Email"
